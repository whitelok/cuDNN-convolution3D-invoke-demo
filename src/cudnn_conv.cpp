...
//cudnnMathType_t math_type = CUDNN_TENSOROP_MATH_ALLOW_CONVERSION;
...
CudnnConv::CudnnConv(int in_n, int in_c, int in_d,  int in_h, int in_w,
        ...
        CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Fail in create cudnnCreateTensorDescriptor");
        ...
        CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Fail in create cudnnCreateConvolutionDescriptor");
        ...
        CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Error in setting Input's cudnnSetTensorNdDescriptorEx");
        ...
        CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Error in setting Output's cudnnSetTensorNdDescriptorEx");
        ...
        sts = cudnnSetConvolutionNdDescriptor(conv_desc_, 
                                              ...
                                              conv_t);
        CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Error in setting convolution's cudnnSetConvolutionNdDescriptor");
        ...
        sts = cudnnSetFilterNdDescriptor(weight_desc_, 
                                         ...
                                         weight_shape_v.size(),
                                         weight_shape_v.data());
        CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Error in setting filter's cudnnSetFilterNdDescriptor");
...
void CudnnConv::InitAlgo(cudnnHandle_t handle) {
    ...
    if (conv_type() == CUDNN_DATA_INT32) {
        ...
        sts = cudnnGetConvolutionForwardAlgorithm(handle, 
                                                  ...
                                                  0,
                                                  &algo_);
        CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Fail in getting cudnnGetConvolutionForwardAlgorithm");
    }
    ...
    CHECK_EXIT(sts != CUDNN_STATUS_SUCCESS, "Fail setting workspace size cudnnGetConvolutionForwardWorkspaceSize");
